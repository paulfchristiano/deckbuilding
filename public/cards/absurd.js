...
import { choice, asChoice, trash, addCosts, move, create, payToDo, free, discharge, addToken, removeToken, gainActions, gainResource, createAndTrack, doAll, moveMany, multichoice, chooseNatural, Victory, } from '../logic.js';
import { register, buyable, registerEvent, actionsEffect, buyEffect, pointsEffect, coinsEffect, targetedEffect, chargeEffect, createEffect, startsWithCharge, applyToTarget, fragileEcho, dedupBy, coin, energy, repeat, } from './index.js';
// ----------------- Absurd --------------------
var confusion = {
    name: 'Confusion',
    buyCost: free,
