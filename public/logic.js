...
function chooseOrder(state, prompt, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, multichoice(state, prompt, options, (function (xs) { return xs.length == options.length; }))];
        });
    });
}
var yesOrNo = [
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            n = state.coin;
                            return [4 /*yield*/, state.setCoin(0)];
                        case 1:
                            state = _a.sent();
    ...
    effect: function (card) { return ({
        ...
        effect: function (state) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, recycle(state.discard)(state)];
                        case 1:
                            state = _a.sent();
                            return [2 /*return*/, state];
                    }
...
var decay = { name: 'Decay',
    ...
    effect: function (card) { return ({
        ...
        effect: function (state) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, doAll(state.discard.map(function (x) { return removeOneToken(x, 'decay'); }))(state)];
                });
            });
        }
    }); },
    triggers: function (card) { return [{
            ...
            kind: 'recycle',
            handles: function () { return true; },
            effect: function (e) { return doAll(e.cards.map(function (c) { return (c.count('decay') >= 3) ? trash(c) : addToken(c, 'decay'); })); }
        }]; }
};
register(decay);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            state = _b.sent();
                            return [4 /*yield*/, multichoiceIfNeeded(state, "Choose up to three cards to discard.", state.deck.map(asChoice), 3, true)];
                        case 2:
                            _a = __read.apply(void 0, [_b.sent(), 2]), state = _a[0], cards = _a[1];
                            return [2 /*return*/, moveMany(cards, 'discard')(state)];
                    }
                });
            });
        }
