...
var reflect = { name: 'Reflect',
    calculatedCost: costPlus(free, coin(1)), effects: [incrementCost(), targetedEffect(function (target, card) { return addToken(target, 'reflect'); }, 'Put a reflect token on a card in your hand', function (state) { return state.hand; })],
    staticTriggers: [{
