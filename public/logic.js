...
import { copper, estate, sets, } from './cards/index.js';
import { cheats } from './cards/cheats.js';
...
export var unk = { name: '?' }; //Used as a default when we don't know the source
...
export function createRaw(state, spec, zone, loc) {
    var _a;
...
export function createRawMulti(state, specs, zone, loc) {
    var e_13, _a, _b;
    if (zone === void 0) { zone = 'discard'; }
    if (loc === void 0) { loc = 'bottom'; }
    try {
...
export function gainEnergy(n, source) {
    if (source === void 0) { source = unk; }
