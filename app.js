...
(() => {
  ...
  registerMirroredCurse(function(isMajor) {
    ...
    return {
      ...
      staticReplacers: [{
        kind: "victory",
        text: ["You need ".concat(vpMultiplier, "x the vp target to win.")],
        handles: function(params) {
          return params.victory;
        },
        replace: function(params, state) {
          return __assign2(__assign2({}, params), { victory: params.victory && state.points >= state.vp_goal * vpMultiplier });
        }
      }]
    };
  });
  ...
  function getRewardOptions(rewardState, metaState) {
    ...
    if (rewardState.kind !== "encounter") {
      ...
      try {
        for (var _b = __values4(getRegisteredExtraOptions()), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  function displayCurseName(spec) {
  ...
  function renderChallenge(spec, state) {
    ...
    var relatedCards = __spreadArray6(__spreadArray6(__spreadArray6(__spreadArray6([], __read7(spec.vpMode.cards), false), __read7(spec.vpMode.events), false), __read7(stageCurse ? [stageCurse] : []), false), __read7(spec.boons.flatMap(function(b) {
  ...
  function deserializeChallenge(challenge) {
    ...
    var curse = challenge.curseName === void 0 ? null : findBaseSpec(challenge.curseName);
    return {
      stage: challenge.stage,
      vpMode,
      boons: resolvedBoons,
      ...
      return __generator4(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            try {
              for (ordered_1 = __values4(ordered), ordered_1_1 = ordered_1.next(); !ordered_1_1.done; ordered_1_1 = ordered_1.next()) {
  ...
  function makePaths(state_1) {
    return __awaiter4(this, arguments, void 0, function(state, challengeTests) {
      var stage, generator, baseRewardsPerPath, basePaths, baseNumBurdens, pathRewardParams, rewardsPerPath, pathOptions, pathCount, numBurdens, challenges, rewardsPerSet, fullSet, totalRewards, completeSets, partialSetRewards, rewardPool, i, shuffledRewards, paths, pathIndex, start, end, pathOption;
      var _a;
      if (challengeTests === void 0) {
        challengeTests = [];
      }
      ...
      return __generator4(this, function(_f) {
        switch (_f.label) {
          ...
          case 1:
            ...
            _a = __values4(path.burdenStates), _b = _a.next();
            _f.label = 2;
          case 2:
            if (!!_b.done) return [3, 6];
          ...
          case 9:
            return [2, { challenges: path.challenges, rewardStates, burdenStates }];
        }
      });
    });
  }
  function applyPathOnSelectEffects(state, path) {
    return __awaiter4(this, void 0, void 0, function() {
      ...
      return __generator4(this, function(_d) {
        ...
        try {
          for (_a = __values4(path.onSelectEffects || []), _b = _a.next(); !_b.done; _b = _a.next()) {
            effect = _b.value;
            _loop_2(effect);
          }
        } catch (e_26_1) {
  ...
  function burdenTestsForStage(tests, stageIndex) {
    ...
    try {
      for (var tests_2 = __values4(tests), tests_2_1 = tests_2.next(); !tests_2_1.done; tests_2_1 = tests_2.next()) {
        ...
        var seen = /* @__PURE__ */ new Set();
        try {
          for (var refs_1 = (e_29 = void 0, __values4(refs)), refs_1_1 = refs_1.next(); !refs_1_1.done; refs_1_1 = refs_1.next()) {
      ...
      return __generator4(this, function(_k) {
        switch (_k.label) {
          case 0:
            ...
            try {
              for (initialBurdenTests_1 = __values4(initialBurdenTests), initialBurdenTests_1_1 = initialBurdenTests_1.next(); !initialBurdenTests_1_1.done; initialBurdenTests_1_1 = initialBurdenTests_1.next()) {
          ...
          case 1:
            _d.apply(_c, [__assign3.apply(void 0, [__assign3.apply(void 0, _e.concat([_k.sent()])), { phase: "stage_select", availablePaths: [] }])]);
            return [3, 3];
          case 2:
            if (onStateChange) {
          ...
          case 3:
            state.ui.updateBuffer(state);
            _loop_3 = function() {
              var sameReplay_1, stage, gameSpec, startingBuffer, _l, score, potionsRemaining, history_1, macros, viewingMacros, usedPotions, persistedMacros, persistedViewingMacros, stageReplays, stageTimelineEntry, nextStage, paths, _m, _o, testSpec2, pathBurdenTests, pathBurdenTests_1, pathBurdenTests_1_1, burdenDefinitions2, paths, path, _p, e_32, _q, _r, _s, selectedChallenge, e_33, e_34, persistedMacros, persistedViewingMacros;
              var e_35, _t, e_36, _u;
              return __generator4(this, function(_v) {
                switch (_v.label) {
                  case 0:
                    _v.trys.push([0, 31, , 32]);
                  ...
                  case 1:
                    _l = _v.sent(), score = _l.score, potionsRemaining = _l.potionsRemaining, history_1 = _l.history, macros = _l.macros, viewingMacros = _l.viewingMacros;
                  ...
                  case 5:
                    paths = _v.sent().map(function(skel) {
                      return pathFromSkeleton(skel);
                    });
                    try {
                      for (_m = (e_35 = void 0, __values4(rewardTestsForStage(tests.rewards, nextStage))), _o = _m.next(); !_o.done; _o = _m.next()) {
                        testSpec2 = _o.value;
                    ...
                    try {
                      for (pathBurdenTests_1 = (e_36 = void 0, __values4(pathBurdenTests)), pathBurdenTests_1_1 = pathBurdenTests_1.next(); !pathBurdenTests_1_1.done; pathBurdenTests_1_1 = pathBurdenTests_1.next()) {
                      ...
                      try {
                        if (pathBurdenTests_1_1 && !pathBurdenTests_1_1.done && (_u = pathBurdenTests_1.return)) _u.call(pathBurdenTests_1);
                      } finally {
                        if (e_36) throw e_36.error;
                      }
                    }
                  ...
                  case 17:
                    _v.sent();
                    _r = (_q = state).replaceAndClearHistory;
                    _s = [{}];
                    return [4, materializePath(state, path)];
                  case 18:
                    _r.apply(_q, [__assign3.apply(void 0, [__assign3.apply(void 0, _s.concat([_v.sent()])), { phase: "stage_select", availablePaths: [] }])]);
                    return [3, 30];
                  case 19:
                  ...
                  case 20:
                    ...
                    _v.label = 21;
                  case 21:
                    _v.trys.push([21, 23, , 26]);
                    return [4, state.ui.waitForChallenge(state)];
                  case 22:
                    selectedChallenge = _v.sent();
                    return [3, 27];
                  case 23:
                    e_33 = _v.sent();
  ...
  var wingedBoots = {
    ...
    metaReplacers: [{
      ...
      replace: function(p) {
        return __assign4(__assign4({}, p), { paths: __spreadArray7(__spreadArray7([], __read8(p.paths), false), ["Use Winged Boots"], false) });
      }
    }]
  };
            ...
            return __generator12(this, function(_d) {
              switch (_d.label) {
                ...
                case 4:
                  ...
                  _a = __values11(rewardState.options), _b = _a.next();
                  _d.label = 5;
                case 5:
  ...
  function renderProgressSidebar(selector, stages) {
    ...
    try {
      for (var stages_1 = __values12(stages), stages_1_1 = stages_1.next(); !stages_1_1.done; stages_1_1 = stages_1.next()) {
  ...
  function showScreen(screen) {
    ...
    try {
      for (var _b = __values14(Object.entries(screens)), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  function renderStageScreen(state, onChallenge, onOptionClick, onBurdenClick, onReplayStage) {
    ...
    state.data.burdenStates.forEach(function(burdenState, burdenIndex) {
      ...
      options.forEach(function(option, optionIndex) {
        ...
        if (option.spec) {
          ...
          if (option.description) {
            try {
              for (var _b2 = __values14(option.description.split("\n")), _c2 = _b2.next(); !_c2.done; _c2 = _b2.next()) {
                var line = _c2.value;
                if (line.length === 0)
                  continue;
                var descDiv = createDiv("rewardOptionDescriptionText");
    ...
    try {
      for (var _b = __values14(state.data.challenges), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  function renderPathSelectionScreen(state, paths, onSelect, onReplayStage) {
    ...
    try {
      for (var _b = __values14(paths.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  function renderPathColumn(path, state, onSelect, index) {
    ...
    try {
      for (var _b = __values14(path.rewardStates), _c = _b.next(); !_c.done; _c = _b.next()) {
  ...
  function showDeckDialog(state) {
    ...
    try {
      for (var sections_1 = __values14(sections), sections_1_1 = sections_1.next(); !sections_1_1.done; sections_1_1 = sections_1.next()) {
        ...
        if (section.items.length > 0) {
          ...
          try {
            for (var _c = (e_10 = void 0, __values14(section.items)), _d = _c.next(); !_d.done; _d = _c.next()) {
              var spec = _d.value;
  ...
  function setCoreUIVisible(visible) {
    ...
    try {
      for (var ids_1 = __values15(ids), ids_1_1 = ids_1.next(); !ids_1_1.done; ids_1_1 = ids_1.next()) {
  ...
  function openHelpDialog() {
    ...
    list.id = "helpList";
    try {
      for (var HELP_ITEMS_1 = __values15(HELP_ITEMS), HELP_ITEMS_1_1 = HELP_ITEMS_1.next(); !HELP_ITEMS_1_1.done; HELP_ITEMS_1_1 = HELP_ITEMS_1.next()) {
  ...
  function renderDeckSection(title, specs) {
    ...
    if (specs.length === 0) {
      ...
      try {
        for (var specs_1 = __values15(specs), specs_1_1 = specs_1.next(); !specs_1_1.done; specs_1_1 = specs_1.next()) {
          var spec = specs_1_1.value;
  ...
  function openViewDialog(slot) {
    ...
    if (state.data.timeline.length === 0) {
      ...
      try {
        for (var _b = __values15(state.data.timeline), _c = _b.next(); !_c.done; _c = _b.next()) {
          var entry = _c.value;
          _loop_1(entry);
        }
      } catch (e_4_1) {
  ...
  function openAllSavesDialog() {
    ...
    if (slots.length === 0) {
      ...
      try {
        for (var slots_1 = __values15(slots), slots_1_1 = slots_1.next(); !slots_1_1.done; slots_1_1 = slots_1.next()) {
  ...
  function renderLauncher() {
    ...
    if (slots.length === 0) {
      ...
      try {
        for (var slots_2 = __values15(slots), slots_2_1 = slots_2.next(); !slots_2_1.done; slots_2_1 = slots_2.next()) {
