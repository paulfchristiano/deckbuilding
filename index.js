        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _b.label = 3;
                case 3:
                    if (!!dailyTypes_1_1.done) return [3 /*break*/, 11];
                ...
                case 6:
                    _b.sent();
                    return [4 /*yield*/, sql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["SELECT secret FROM secrets WHERE key=", ""], ["SELECT secret FROM secrets WHERE key=", ""])), key)];
                case 7:
                    results = _b.sent();
                    return [3 /*break*/, 5];
                case 8:
...
function fixupNextMonth() {
    return __awaiter(this, void 0, void 0, function () {
        var d, i, dailyTypes_2, dailyTypes_2_1, type, key, secret, results, url, e_3_1;
        var e_3, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    ...
                    dailyTypes_2 = (e_3 = void 0, __values(dailyTypes)), dailyTypes_2_1 = dailyTypes_2.next();
                    _b.label = 3;
                case 3:
                    if (!!dailyTypes_2_1.done) return [3 /*break*/, 7];
                    type = dailyTypes_2_1.value;
                    key = makeDailyKey(type, d);
                    secret = void 0;
                    return [4 /*yield*/, sql(templateObject_8 || (templateObject_8 = __makeTemplateObject(["SELECT secret FROM secrets WHERE key=", ""], ["SELECT secret FROM secrets WHERE key=", ""])), key)];
                case 4:
                    results = _b.sent();
                    if (results.length == 0)
                        return [3 /*break*/, 6];
                    secret = results[0].secret;
                    url = makeDailyURL(key, secret);
                    return [4 /*yield*/, sql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n            INSERT INTO dailies (type, key, secret, url)\n                        values (", ", ", ", ", ", ", ")\n            ON CONFLICT(key, type) DO UPDATE SET\n              secret=", ",\n              url=", ",\n              best_user=NULL,\n              best_score=NULL,\n              version=NULL\n        "], ["\n            INSERT INTO dailies (type, key, secret, url)\n                        values (", ", ", ", ", ", ", ")\n            ON CONFLICT(key, type) DO UPDATE SET\n              secret=", ",\n              url=", ",\n              best_user=NULL,\n              best_score=NULL,\n              version=NULL\n        "])), type, key, secret, url, secret, url)];
                case 5:
                    _b.sent();
                    _b.label = 6;
                case 6:
...
function submitForDaily(username, url, score) {
    return __awaiter(this, void 0, void 0, function () {
        var dailyTypes_3, dailyTypes_3_1, type, _a, e_4_1;
        var e_4, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    dailyTypes_3 = __values(dailyTypes), dailyTypes_3_1 = dailyTypes_3.next();
                    _c.label = 2;
                case 2:
                    if (!!dailyTypes_3_1.done) return [3 /*break*/, 6];
                    type = dailyTypes_3_1.value;
                    _a = url;
                ...
                case 4:
                    ...
                    _c.label = 5;
                case 5:
                    dailyTypes_3_1 = dailyTypes_3.next();
                    return [3 /*break*/, 2];
                ...
                case 8:
                    try {
                        if (dailyTypes_3_1 && !dailyTypes_3_1.done && (_b = dailyTypes_3.return)) _b.call(dailyTypes_3);
                    }
...
function migrateScores() {
    return __awaiter(this, void 0, void 0, function () {
        var results, migrated, failed, results_1, results_1_1, result, spec, _a, valid, explanation, e_5_1;
        var e_5, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["SELECT * FROM scoreboard WHERE knownobsolete=FALSE AND version!=", ""], ["SELECT * FROM scoreboard WHERE knownobsolete=FALSE AND version!=", ""])), VERSION)];
                case 1:
                    results = _c.sent();
                ...
                case 2:
                    ...
                    _c.label = 3;
                case 3:
                    if (!!results_1_1.done) return [3 /*break*/, 9];
                ...
                case 11:
                    ...
                    return [7 /*endfinally*/];
                case 12: return [2 /*return*/, "Migrated " + migrated + ", Failed " + failed];
            }
        });
    });
}
...
function verifyAllCampaignLevels() {
    return __awaiter(this, void 0, void 0, function () {
        var result, rows, rows_1, rows_1_1, row, url;
        var e_6, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
function dailyTypeFromReq(req) {
    ...
    var type = undefined;
    try {
        for (var dailyTypes_4 = __values(dailyTypes), dailyTypes_4_1 = dailyTypes_4.next(); !dailyTypes_4_1.done; dailyTypes_4_1 = dailyTypes_4.next()) {
            var dailyType = dailyTypes_4_1.value;
...
function freeToSpoil(url) {
    return __awaiter(this, void 0, void 0, function () {
        var dailyTypes_5, dailyTypes_5_1, type, dailyURLs, isCampaign, e_8_1;
        var e_8, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
function isCampaignLevel(url) {
    return __awaiter(this, void 0, void 0, function () {
        var levels;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["SELECT key\n    FROM campaign_levels WHERE url=", ""], ["SELECT key\n    FROM campaign_levels WHERE url=", ""])), url)];
                case 1:
                    levels = _a.sent();
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, sql(templateObject_20 || (templateObject_20 = __makeTemplateObject(["UPDATE campaign_users\n              SET max_stars = ", "\n              WHERE name = ", ""], ["UPDATE campaign_users\n              SET max_stars = ", "\n              WHERE name = ", ""])), newMaxStars, username)];
                case 4:
                    _e.sent();
                    return [2 /*return*/, getCampaignInfo(username, cheat)];
                case 5:
                    lockedLevels = new Map();
                    return [4 /*yield*/, sql(templateObject_21 || (templateObject_21 = __makeTemplateObject(["SELECT destination, req FROM campaign_requirements"], ["SELECT destination, req FROM campaign_requirements"])))];
                case 6:
...
express()
    ...
    .post('/migrate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, migrateScores()];
            case 1:
                results = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sql(templateObject_24 || (templateObject_24 = __makeTemplateObject(["\n        SELECT id, url FROM links\n        WHERE id=", "\n      "], ["\n        SELECT id, url FROM links\n        WHERE id=", "\n      "])), req.params.id)];
            case 1:
                results = _a.sent();
                if (results.length < 1) {
    ...
    .get('/verify', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, verifyAllCampaignLevels()];
            case 1:
                results = _a.sent();
                res.send(results.map(function (x) { return "<p>" + x + "</p>"; }).join(''));
                return [2 /*return*/];
        }
    });
}); })
    .get('/fixup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fixupNextMonth()];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, sql(templateObject_27 || (templateObject_27 = __makeTemplateObject(["SELECT key\n        FROM campaign_levels WHERE url=", ""], ["SELECT key\n        FROM campaign_levels WHERE url=", ""])), url)];
            case 3:
                levels = _c.sent();
                if (levels.length == 0) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, sql(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n              SELECT username, score, submitted, url, version FROM scoreboard\n              ORDER BY submitted DESC\n              LIMIT 100\n          "], ["\n              SELECT username, score, submitted, url, version FROM scoreboard\n              ORDER BY submitted DESC\n              LIMIT 100\n          "])))];
            case 1:
                results = _a.sent();
